...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_solutions(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_solutions(mgr, namespacedOpts), "Cannot setup Azure controllers")
