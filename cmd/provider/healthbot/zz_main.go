...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_healthbot(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_healthbot(mgr, namespacedOpts), "Cannot setup Azure controllers")
