...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_customproviders(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_customproviders(mgr, namespacedOpts), "Cannot setup Azure controllers")
