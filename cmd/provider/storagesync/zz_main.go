...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_storagesync(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_storagesync(mgr, namespacedOpts), "Cannot setup Azure controllers")
