...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_operationsmanagement(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_operationsmanagement(mgr, namespacedOpts), "Cannot setup Azure controllers")
