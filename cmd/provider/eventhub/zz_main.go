...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_eventhub(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_eventhub(mgr, namespacedOpts), "Cannot setup Azure controllers")
