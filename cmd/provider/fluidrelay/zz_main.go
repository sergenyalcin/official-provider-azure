...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_fluidrelay(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_fluidrelay(mgr, namespacedOpts), "Cannot setup Azure controllers")
