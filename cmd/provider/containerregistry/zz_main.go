...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_containerregistry(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_containerregistry(mgr, namespacedOpts), "Cannot setup Azure controllers")
