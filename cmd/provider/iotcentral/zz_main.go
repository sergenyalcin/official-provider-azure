...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_iotcentral(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_iotcentral(mgr, namespacedOpts), "Cannot setup Azure controllers")
