...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_servicefabric(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_servicefabric(mgr, namespacedOpts), "Cannot setup Azure controllers")
