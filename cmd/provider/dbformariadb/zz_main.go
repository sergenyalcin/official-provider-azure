...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_dbformariadb(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_dbformariadb(mgr, namespacedOpts), "Cannot setup Azure controllers")
