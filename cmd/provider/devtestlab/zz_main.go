...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_devtestlab(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_devtestlab(mgr, namespacedOpts), "Cannot setup Azure controllers")
