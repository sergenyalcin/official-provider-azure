...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_synapse(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_synapse(mgr, namespacedOpts), "Cannot setup Azure controllers")
