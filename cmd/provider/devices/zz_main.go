...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_devices(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_devices(mgr, namespacedOpts), "Cannot setup Azure controllers")
