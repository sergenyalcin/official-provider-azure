...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_eventgrid(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_eventgrid(mgr, namespacedOpts), "Cannot setup Azure controllers")
