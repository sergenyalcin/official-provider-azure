...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_elastic(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_elastic(mgr, namespacedOpts), "Cannot setup Azure controllers")
