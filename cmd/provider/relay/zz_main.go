...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_relay(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_relay(mgr, namespacedOpts), "Cannot setup Azure controllers")
