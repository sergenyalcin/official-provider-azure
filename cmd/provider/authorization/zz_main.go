...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_authorization(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_authorization(mgr, namespacedOpts), "Cannot setup Azure controllers")
