...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_management(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_management(mgr, namespacedOpts), "Cannot setup Azure controllers")
