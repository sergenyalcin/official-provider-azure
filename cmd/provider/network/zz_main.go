...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_network(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_network(mgr, namespacedOpts), "Cannot setup Azure controllers")
