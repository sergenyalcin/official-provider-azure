...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_insights(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_insights(mgr, namespacedOpts), "Cannot setup Azure controllers")
