...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_servicelinker(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_servicelinker(mgr, namespacedOpts), "Cannot setup Azure controllers")
