...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_search(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_search(mgr, namespacedOpts), "Cannot setup Azure controllers")
