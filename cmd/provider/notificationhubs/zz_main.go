...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_notificationhubs(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_notificationhubs(mgr, namespacedOpts), "Cannot setup Azure controllers")
