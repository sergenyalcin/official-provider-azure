...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_appconfiguration(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_appconfiguration(mgr, namespacedOpts), "Cannot setup Azure controllers")
