...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_dbformysql(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_dbformysql(mgr, namespacedOpts), "Cannot setup Azure controllers")
