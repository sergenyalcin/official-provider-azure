...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_automation(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_automation(mgr, namespacedOpts), "Cannot setup Azure controllers")
