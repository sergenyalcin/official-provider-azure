...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_compute(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_compute(mgr, namespacedOpts), "Cannot setup Azure controllers")
