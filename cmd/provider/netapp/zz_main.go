...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_netapp(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_netapp(mgr, namespacedOpts), "Cannot setup Azure controllers")
