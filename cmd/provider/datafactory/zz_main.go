...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_datafactory(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_datafactory(mgr, namespacedOpts), "Cannot setup Azure controllers")
