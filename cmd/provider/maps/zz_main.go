...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_maps(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_maps(mgr, namespacedOpts), "Cannot setup Azure controllers")
