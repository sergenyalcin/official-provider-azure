...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_containerapp(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_containerapp(mgr, namespacedOpts), "Cannot setup Azure controllers")
