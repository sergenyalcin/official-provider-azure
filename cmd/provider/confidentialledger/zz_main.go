...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_confidentialledger(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_confidentialledger(mgr, namespacedOpts), "Cannot setup Azure controllers")
