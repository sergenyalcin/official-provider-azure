...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_sql(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_sql(mgr, namespacedOpts), "Cannot setup Azure controllers")
