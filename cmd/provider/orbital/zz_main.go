...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_orbital(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_orbital(mgr, namespacedOpts), "Cannot setup Azure controllers")
