...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_azure(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_azure(mgr, namespacedOpts), "Cannot setup Azure controllers")
