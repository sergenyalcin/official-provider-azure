...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_botservice(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_botservice(mgr, namespacedOpts), "Cannot setup Azure controllers")
