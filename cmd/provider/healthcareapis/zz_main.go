...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_healthcareapis(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_healthcareapis(mgr, namespacedOpts), "Cannot setup Azure controllers")
