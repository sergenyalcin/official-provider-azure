...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_consumption(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_consumption(mgr, namespacedOpts), "Cannot setup Azure controllers")
