...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_cosmosdb(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_cosmosdb(mgr, namespacedOpts), "Cannot setup Azure controllers")
