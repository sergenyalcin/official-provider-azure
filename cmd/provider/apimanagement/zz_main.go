...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_apimanagement(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_apimanagement(mgr, namespacedOpts), "Cannot setup Azure controllers")
