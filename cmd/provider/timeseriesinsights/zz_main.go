...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_timeseriesinsights(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_timeseriesinsights(mgr, namespacedOpts), "Cannot setup Azure controllers")
