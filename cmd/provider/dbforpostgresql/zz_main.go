...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_dbforpostgresql(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_dbforpostgresql(mgr, namespacedOpts), "Cannot setup Azure controllers")
