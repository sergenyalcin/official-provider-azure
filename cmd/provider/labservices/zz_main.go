...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_labservices(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_labservices(mgr, namespacedOpts), "Cannot setup Azure controllers")
