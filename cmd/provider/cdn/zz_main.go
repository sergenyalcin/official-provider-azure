...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_cdn(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_cdn(mgr, namespacedOpts), "Cannot setup Azure controllers")
