...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_policyinsights(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_policyinsights(mgr, namespacedOpts), "Cannot setup Azure controllers")
