...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_cache(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_cache(mgr, namespacedOpts), "Cannot setup Azure controllers")
