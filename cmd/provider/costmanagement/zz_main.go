...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_costmanagement(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_costmanagement(mgr, namespacedOpts), "Cannot setup Azure controllers")
