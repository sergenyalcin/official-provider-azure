...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_alertsmanagement(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_alertsmanagement(mgr, namespacedOpts), "Cannot setup Azure controllers")
