...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_marketplaceordering(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_marketplaceordering(mgr, namespacedOpts), "Cannot setup Azure controllers")
