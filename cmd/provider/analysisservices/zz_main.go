...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_analysisservices(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_analysisservices(mgr, namespacedOpts), "Cannot setup Azure controllers")
