...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_azurestackhci(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_azurestackhci(mgr, namespacedOpts), "Cannot setup Azure controllers")
