...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_digitaltwins(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_digitaltwins(mgr, namespacedOpts), "Cannot setup Azure controllers")
