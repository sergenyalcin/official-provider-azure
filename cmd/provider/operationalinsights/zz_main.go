...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_operationalinsights(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_operationalinsights(mgr, namespacedOpts), "Cannot setup Azure controllers")
