...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_keyvault(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_keyvault(mgr, namespacedOpts), "Cannot setup Azure controllers")
