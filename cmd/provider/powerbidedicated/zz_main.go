...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_powerbidedicated(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_powerbidedicated(mgr, namespacedOpts), "Cannot setup Azure controllers")
