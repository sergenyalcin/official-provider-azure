...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_hdinsight(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_hdinsight(mgr, namespacedOpts), "Cannot setup Azure controllers")
