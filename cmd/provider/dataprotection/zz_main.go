...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_dataprotection(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_dataprotection(mgr, namespacedOpts), "Cannot setup Azure controllers")
