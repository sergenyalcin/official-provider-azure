...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_cognitiveservices(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_cognitiveservices(mgr, namespacedOpts), "Cannot setup Azure controllers")
