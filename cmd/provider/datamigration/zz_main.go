...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_datamigration(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_datamigration(mgr, namespacedOpts), "Cannot setup Azure controllers")
