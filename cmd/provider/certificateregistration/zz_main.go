...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_certificateregistration(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_certificateregistration(mgr, namespacedOpts), "Cannot setup Azure controllers")
