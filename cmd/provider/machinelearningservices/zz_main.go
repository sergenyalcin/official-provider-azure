...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_machinelearningservices(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_machinelearningservices(mgr, namespacedOpts), "Cannot setup Azure controllers")
