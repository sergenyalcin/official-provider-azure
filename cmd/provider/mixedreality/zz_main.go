...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_mixedreality(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_mixedreality(mgr, namespacedOpts), "Cannot setup Azure controllers")
