...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_media(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_media(mgr, namespacedOpts), "Cannot setup Azure controllers")
