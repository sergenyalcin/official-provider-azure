...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_securityinsights(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_securityinsights(mgr, namespacedOpts), "Cannot setup Azure controllers")
