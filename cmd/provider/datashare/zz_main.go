...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_datashare(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_datashare(mgr, namespacedOpts), "Cannot setup Azure controllers")
