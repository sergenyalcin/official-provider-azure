...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_config(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_config(mgr, namespacedOpts), "Cannot setup Azure controllers")
