...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_streamanalytics(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_streamanalytics(mgr, namespacedOpts), "Cannot setup Azure controllers")
