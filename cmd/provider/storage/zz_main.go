...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_storage(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_storage(mgr, namespacedOpts), "Cannot setup Azure controllers")
