...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_servicebus(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_servicebus(mgr, namespacedOpts), "Cannot setup Azure controllers")
