...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_storagepool(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_storagepool(mgr, namespacedOpts), "Cannot setup Azure controllers")
