...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_loadtestservice(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_loadtestservice(mgr, namespacedOpts), "Cannot setup Azure controllers")
