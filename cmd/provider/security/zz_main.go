...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_security(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_security(mgr, namespacedOpts), "Cannot setup Azure controllers")
