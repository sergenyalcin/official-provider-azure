...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_databoxedge(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_databoxedge(mgr, namespacedOpts), "Cannot setup Azure controllers")
