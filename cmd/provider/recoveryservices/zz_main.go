...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_recoveryservices(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_recoveryservices(mgr, namespacedOpts), "Cannot setup Azure controllers")
