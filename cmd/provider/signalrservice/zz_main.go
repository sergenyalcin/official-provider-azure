...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_signalrservice(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_signalrservice(mgr, namespacedOpts), "Cannot setup Azure controllers")
