...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_storagecache(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_storagecache(mgr, namespacedOpts), "Cannot setup Azure controllers")
