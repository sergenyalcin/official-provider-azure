...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_logic(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_logic(mgr, namespacedOpts), "Cannot setup Azure controllers")
