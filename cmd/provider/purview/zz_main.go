...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_purview(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_purview(mgr, namespacedOpts), "Cannot setup Azure controllers")
