...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_deviceupdate(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_deviceupdate(mgr, namespacedOpts), "Cannot setup Azure controllers")
