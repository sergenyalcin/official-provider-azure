...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_attestation(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_attestation(mgr, namespacedOpts), "Cannot setup Azure controllers")
