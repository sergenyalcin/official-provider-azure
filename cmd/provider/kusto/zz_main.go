...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_kusto(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_kusto(mgr, namespacedOpts), "Cannot setup Azure controllers")
