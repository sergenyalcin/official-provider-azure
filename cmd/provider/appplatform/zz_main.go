...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_appplatform(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_appplatform(mgr, namespacedOpts), "Cannot setup Azure controllers")
