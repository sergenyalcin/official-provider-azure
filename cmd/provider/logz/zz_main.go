...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_logz(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_logz(mgr, namespacedOpts), "Cannot setup Azure controllers")
