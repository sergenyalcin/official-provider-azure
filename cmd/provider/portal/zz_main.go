...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_portal(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_portal(mgr, namespacedOpts), "Cannot setup Azure controllers")
