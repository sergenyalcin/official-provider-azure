...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_databricks(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_databricks(mgr, namespacedOpts), "Cannot setup Azure controllers")
