...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_managedidentity(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_managedidentity(mgr, namespacedOpts), "Cannot setup Azure controllers")
