...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_spring(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_spring(mgr, namespacedOpts), "Cannot setup Azure controllers")
