...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_monolith(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_monolith(mgr, namespacedOpts), "Cannot setup Azure controllers")
