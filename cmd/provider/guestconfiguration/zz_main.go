...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_guestconfiguration(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_guestconfiguration(mgr, namespacedOpts), "Cannot setup Azure controllers")
