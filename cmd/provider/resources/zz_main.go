...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_resources(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_resources(mgr, namespacedOpts), "Cannot setup Azure controllers")
