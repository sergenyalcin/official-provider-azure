...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_maintenance(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_maintenance(mgr, namespacedOpts), "Cannot setup Azure controllers")
