...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_communication(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_communication(mgr, namespacedOpts), "Cannot setup Azure controllers")
