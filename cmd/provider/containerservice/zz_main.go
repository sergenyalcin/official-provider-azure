...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_containerservice(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_containerservice(mgr, namespacedOpts), "Cannot setup Azure controllers")
