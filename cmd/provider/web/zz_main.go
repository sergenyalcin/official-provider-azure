...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_web(mgr, clusterOpts), "Cannot setup Azure controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_web(mgr, namespacedOpts), "Cannot setup Azure controllers")
