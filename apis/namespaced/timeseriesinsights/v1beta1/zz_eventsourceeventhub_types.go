...
type EventSourceEventHubInitParameters struct {
	...
	ConsumerGroupNameRef *v1.NamespacedReference `json:"consumerGroupNameRef,omitempty" tf:"-"`

	// Selector for a ConsumerGroup in eventhub to populate consumerGroupName.
	// +kubebuilder:validation:Optional
	ConsumerGroupNameSelector *v1.NamespacedSelector `json:"consumerGroupNameSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	EventSourceResourceIDRef *v1.NamespacedReference `json:"eventSourceResourceIdRef,omitempty" tf:"-"`

	// Selector for a EventHub in eventhub to populate eventSourceResourceId.
	// +kubebuilder:validation:Optional
	EventSourceResourceIDSelector *v1.NamespacedSelector `json:"eventSourceResourceIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/namespaced/eventhub/v1beta1.AuthorizationRule
	...
	// +kubebuilder:validation:Optional
	SharedAccessKeyNameRef *v1.NamespacedReference `json:"sharedAccessKeyNameRef,omitempty" tf:"-"`

	// Selector for a AuthorizationRule in eventhub to populate sharedAccessKeyName.
	// +kubebuilder:validation:Optional
	SharedAccessKeyNameSelector *v1.NamespacedSelector `json:"sharedAccessKeyNameSelector,omitempty" tf:"-"`
	...
	SharedAccessKeySecretRef v1.LocalSecretKeySelector `json:"sharedAccessKeySecretRef" tf:"-"`
...
type EventSourceEventHubParameters struct {
	...
	// Specifies the id of the IoT Time Series Insights Environment that the Event Source should be associated with. Changing this forces a new resource to created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/namespaced/timeseriesinsights/v1beta1.Gen2Environment
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractResourceID()
	// +kubebuilder:validation:Optional
	EnvironmentID *string `json:"environmentId,omitempty" tf:"environment_id,omitempty"`
