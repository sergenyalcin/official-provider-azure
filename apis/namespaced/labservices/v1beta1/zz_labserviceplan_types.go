...
type LabServicePlanInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AllowedRegionsRefs []v1.NamespacedReference `json:"allowedRegionsRefs,omitempty" tf:"-"`

	// Selector for a list of ResourceGroup in azure to populate allowedRegions.
	// +kubebuilder:validation:Optional
	AllowedRegionsSelector *v1.NamespacedSelector `json:"allowedRegionsSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	DefaultNetworkSubnetIDRef *v1.NamespacedReference `json:"defaultNetworkSubnetIdRef,omitempty" tf:"-"`

	// Selector for a Subnet in network to populate defaultNetworkSubnetId.
	// +kubebuilder:validation:Optional
	DefaultNetworkSubnetIDSelector *v1.NamespacedSelector `json:"defaultNetworkSubnetIdSelector,omitempty" tf:"-"`
