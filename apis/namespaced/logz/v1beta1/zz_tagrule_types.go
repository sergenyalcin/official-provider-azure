...
type TagRuleParameters struct {
	...
	// The ID of the Logz Monitor. Changing this forces a new logz Tag Rule to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/namespaced/logz/v1beta1.Monitor
	...
	// +kubebuilder:validation:Optional
	LogzMonitorIDRef *v1.NamespacedReference `json:"logzMonitorIdRef,omitempty" tf:"-"`

	// Selector for a Monitor in logz to populate logzMonitorId.
	// +kubebuilder:validation:Optional
	LogzMonitorIDSelector *v1.NamespacedSelector `json:"logzMonitorIdSelector,omitempty" tf:"-"`
