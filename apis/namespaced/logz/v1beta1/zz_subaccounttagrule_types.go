...
type SubAccountTagRuleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/namespaced/logz/v1beta1.SubAccount
	...
	LogzSubAccountIDRef *v1.NamespacedReference `json:"logzSubAccountIdRef,omitempty" tf:"-"`

	// Selector for a SubAccount in logz to populate logzSubAccountId.
	// +kubebuilder:validation:Optional
	LogzSubAccountIDSelector *v1.NamespacedSelector `json:"logzSubAccountIdSelector,omitempty" tf:"-"`
