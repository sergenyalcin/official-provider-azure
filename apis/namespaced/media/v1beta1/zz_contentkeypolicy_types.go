...
type AlternateKeyInitParameters struct {
	...
	RsaTokenKeyExponentSecretRef *v1.LocalSecretKeySelector `json:"rsaTokenKeyExponentSecretRef,omitempty" tf:"-"`

	// The RSA parameter modulus.
	RsaTokenKeyModulusSecretRef *v1.LocalSecretKeySelector `json:"rsaTokenKeyModulusSecretRef,omitempty" tf:"-"`

	// The key value of the key. Specifies a symmetric key for token validation.
	SymmetricTokenKeySecretRef *v1.LocalSecretKeySelector `json:"symmetricTokenKeySecretRef,omitempty" tf:"-"`
	...
	X509TokenKeyRawSecretRef *v1.LocalSecretKeySelector `json:"x509TokenKeyRawSecretRef,omitempty" tf:"-"`
}
...
type ContentKeyPolicyParameters struct {
	...
	// The Media Services account name. Changing this forces a new Content Key Policy to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/namespaced/media/v1beta1.ServicesAccount
	// +kubebuilder:validation:Optional
	MediaServicesAccountName *string `json:"mediaServicesAccountName,omitempty" tf:"media_services_account_name,omitempty"`

	// Reference to a ServicesAccount in media to populate mediaServicesAccountName.
	// +kubebuilder:validation:Optional
	MediaServicesAccountNameRef *v1.NamespacedReference `json:"mediaServicesAccountNameRef,omitempty" tf:"-"`

	// Selector for a ServicesAccount in media to populate mediaServicesAccountName.
	// +kubebuilder:validation:Optional
	MediaServicesAccountNameSelector *v1.NamespacedSelector `json:"mediaServicesAccountNameSelector,omitempty" tf:"-"`
...
type FairplayConfigurationInitParameters struct {
	...
	AskSecretRef *v1.LocalSecretKeySelector `json:"askSecretRef,omitempty" tf:"-"`
	...
	PfxPasswordSecretRef *v1.LocalSecretKeySelector `json:"pfxPasswordSecretRef,omitempty" tf:"-"`

	// The Base64 representation of FairPlay certificate in PKCS 12 (pfx) format (including private key).
	PfxSecretRef *v1.LocalSecretKeySelector `json:"pfxSecretRef,omitempty" tf:"-"`
...
type PlayreadyConfigurationLicenseInitParameters struct {
	...
	GracePeriodSecretRef *v1.LocalSecretKeySelector `json:"gracePeriodSecretRef,omitempty" tf:"-"`
...
type TokenRestrictionInitParameters struct {
	...
	// The RSA parameter exponent.
	PrimaryRsaTokenKeyExponentSecretRef *v1.LocalSecretKeySelector `json:"primaryRsaTokenKeyExponentSecretRef,omitempty" tf:"-"`

	// The RSA parameter modulus.
	PrimaryRsaTokenKeyModulusSecretRef *v1.LocalSecretKeySelector `json:"primaryRsaTokenKeyModulusSecretRef,omitempty" tf:"-"`

	// The key value of the key. Specifies a symmetric key for token validation.
	PrimarySymmetricTokenKeySecretRef *v1.LocalSecretKeySelector `json:"primarySymmetricTokenKeySecretRef,omitempty" tf:"-"`

	// The raw data field of a certificate in PKCS 12 format (X509Certificate2 in .NET). Specifies a certificate for token validation.
	PrimaryX509TokenKeyRawSecretRef *v1.LocalSecretKeySelector `json:"primaryX509TokenKeyRawSecretRef,omitempty" tf:"-"`
