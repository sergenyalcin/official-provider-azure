...
type StreamingLocatorInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/namespaced/media/v1beta1.Asset
	AssetName *string `json:"assetName,omitempty" tf:"asset_name,omitempty"`

	// Reference to a Asset in media to populate assetName.
	// +kubebuilder:validation:Optional
	AssetNameRef *v1.NamespacedReference `json:"assetNameRef,omitempty" tf:"-"`

	// Selector for a Asset in media to populate assetName.
	// +kubebuilder:validation:Optional
	AssetNameSelector *v1.NamespacedSelector `json:"assetNameSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/namespaced/media/v1beta1.ServicesAccountFilter
	...
	// +kubebuilder:validation:Optional
	FilterNamesRefs []v1.NamespacedReference `json:"filterNamesRefs,omitempty" tf:"-"`

	// Selector for a list of ServicesAccountFilter in media to populate filterNames.
	// +kubebuilder:validation:Optional
	FilterNamesSelector *v1.NamespacedSelector `json:"filterNamesSelector,omitempty" tf:"-"`
