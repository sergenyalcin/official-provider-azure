...
type LiveEventOutputParameters struct {
	...
	// The id of the live event. Changing this forces a new Live Output to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/namespaced/media/v1beta1.LiveEvent
	...
	// +kubebuilder:validation:Optional
	LiveEventIDRef *v1.NamespacedReference `json:"liveEventIdRef,omitempty" tf:"-"`

	// Selector for a LiveEvent in media to populate liveEventId.
	// +kubebuilder:validation:Optional
	LiveEventIDSelector *v1.NamespacedSelector `json:"liveEventIdSelector,omitempty" tf:"-"`
