...
type MonitorActionRuleSuppressionScopeInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ResourceIdsRefs []v1.NamespacedReference `json:"resourceIdsRefs,omitempty" tf:"-"`

	// Selector for a list of ResourceGroup in azure to populate resourceIds.
	// +kubebuilder:validation:Optional
	ResourceIdsSelector *v1.NamespacedSelector `json:"resourceIdsSelector,omitempty" tf:"-"`
