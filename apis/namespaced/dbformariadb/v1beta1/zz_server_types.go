...
type ServerInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/namespaced/dbformariadb/v1beta1.Server
	...
	CreationSourceServerIDRef *v1.NamespacedReference `json:"creationSourceServerIdRef,omitempty" tf:"-"`

	// Selector for a Server in dbformariadb to populate creationSourceServerId.
	// +kubebuilder:validation:Optional
	CreationSourceServerIDSelector *v1.NamespacedSelector `json:"creationSourceServerIdSelector,omitempty" tf:"-"`
