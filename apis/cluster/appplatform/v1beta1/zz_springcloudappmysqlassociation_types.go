...
type SpringCloudAppMySQLAssociationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/cluster/dbformysql/v1beta1.Database
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/cluster/dbformysql/v1beta2.Server
